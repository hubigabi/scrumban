...
class TaskRepositoryTest {
    ...
    private List<Column> columns1;
    private List<Column> columns2;
    ...
    public void initDB() {
        ...
        columns1 = Column.getDefaultColumns(p1);
        columns2 = Column.getDefaultColumns(p2);
        columnRepository.saveAll(columns1);
        columnRepository.saveAll(columns2);
        ...
        Task t16 = new Task("Web sockets", "Nam auctor enim at erat porta, ut elementum nibh ultrices.", 2, LocalDate.now().minusDays(11), LocalDate.now().minusDays(5), columns1.get(0), p1);
        ...
        Task t26 = new Task("Web sockets", "Curabitur nec leo faucibus, posuere augue at, eleifend diam. ", 3, LocalDate.now().minusDays(10), LocalDate.now().minusDays(3), columns2.get(5), p2);
    ...
    void save() {
        ...
        Column column = columns1.get(0);
        Task task = new Task("New task", "New task description", 1, LocalDate.now().minusDays(10), null, column, project);
